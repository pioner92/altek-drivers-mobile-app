...
export const PlaceBidErrorModal:React.FC = () => {
    ...
    return (
        <AlertModal title={"Error"}  rightButtonLabel="Ok" onPressRightButton={closeModal} animStyle={opacity}>
            <Text style={{fontFamily:'IBMPlex-500',color:styleConfig.textColor.dark,fontSize:14,textAlign:"center"}}>This load was deleted</Text>
        </AlertModal>
    )
}