...
export const BankDetailInputs: React.FC = () => {
    ...
    return (
        <WhiteCard style={{marginTop:26}}>
            ...
            <Input type='name-phone-pad' onChange={setInputValueCardHoldName} value={holdName} placeholder='Holder Name'/>
            <View style={{flexDirection: "row",justifyContent:"space-between"}}>
                <Input type='default' style={{flex:1}} onChange={setInputValueCardDate} value={cardDate} placeholder='Month/Year'/>
                <Input type='number-pad' style={{flex:1}} onChange={setInputValueCardCVS} value={cardCvs} placeholder='CVC'/>
            </View>
        </WhiteCard>
    );
};
