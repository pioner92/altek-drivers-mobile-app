    ...
    return (
        <View style={styles.container}>
            <View style={[styles.content,styleConfig.shadowMenu]}>
                <Header/>
                <Row inputValue={piecesValue} onChange={onChangePieces} description={piecesDescription} label='Pieces' currentValue={currentPieces}/>
                <Line/>
                <Row inputValue={weightValue} onChange={onChangeWeight} description={weightDescription} label='Total Weight' currentValue={currentWeight}/>
            </View>
        </View>
    );
};
