...
import {$imageDataTruck} from "../uploading-verified-step-3/models";
...
import {$imageDataBol} from "../uploading-verified-step-2/models";
...
export const UploadingVerifiedStep4: React.FC = () => {
    ...
    return (
        <ScreenWrapper isEnabledHeightController={true}>
            <ScrollView contentContainerStyle={{paddingHorizontal:styleConfig.screenPadding,paddingBottom:30}} style={styles.container}>
                    <TitleEditRow callback={() => {
                    }}>Details</TitleEditRow>
                    <Load piecesDescription={'0x0x0'} weightDescription={'lbs'}/>
                    <TitleEditRow callback={() => {
                    }}>BOL</TitleEditRow>
                    <InputBol/>
                    <TitleEditRow callback={() => {
