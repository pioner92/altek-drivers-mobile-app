...
import {Text, Animated, View, ScrollView, TouchableOpacity, Platform} from "react-native";
...
export const InfoCard: React.FC<propsType> = ({data}) => {
    ...
    const showMore = () => {
        useSpring(animValue, 1, 10, 8, false).start()
    }
    const showLess = () => {
        useSpring(animValue, 0, 10, 8, false).start()
    }
